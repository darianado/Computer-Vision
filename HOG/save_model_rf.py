...
Description of File:    Using the trained Random Forest model, the program will apply the bounding boxes i.e. parking spaces 
...
joblib.dump(rf_best, os.path.join(models_folder, "random_forest_model.pkl"))
